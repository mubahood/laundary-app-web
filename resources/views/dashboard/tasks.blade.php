...
<div class="card mb-4 mb-md-5 border-0 ">
    <div class="card-header p-0 bg-primary rounded-top "
        ...
        <h3 class="px-4 pb-2  text-white py-4 fs-20 fw-700"><b>{{ $title }}</b>
            <br>
            <a href="{{ admin_url('medical-services') }}"><small class="text-white">View All</small></a>
        </h3>
            ...
            @else
                @foreach ($items as $item)
                    ...
                    <a href="{{ admin_url('consultations/' . $item->id) }}/edit" target="_blank"
                        ...
                        <p class="mb-1">
                            <b>{{ $item->type }}:</b> {{ $item->instruction }}.
                        </p>
